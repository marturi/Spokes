...
public class SmartBikeStationCriteria {
	private String topLeft;
	private String bottomRight;
	private LinearRing boundingBox;
	private Map<String,String> options;

	public SmartBikeStationCriteria(String topLeft, String bottomRight, Map<String,String> options){
		this.topLeft = topLeft;
		this.bottomRight = bottomRight;
		this.options = options;
	}

	public void validateSmartBikeStationCriteria(GeometryFactory geometryFactory) throws SpokesException{
		if(getBoundingBox(geometryFactory) == null){
			throw new MissingInputException("The required input for finding the nearest smart bike stations is missing.  Please try again.");
		}
	}
