...
@implementation RouteNavigationView
...
- (void) placeRouteNavigatorButton {
	if(self.routeNavigator == nil) {
		...
		[self.routeNavigator addTarget:_rootViewController
...
- (void) initRouteNavigator:(Route*)currentRoute 
		   currentRouteView:(RouteView*)currentRouteView {
	int currLegIdx = [currentRoute.currentLegIndex intValue];
	if(currLegIdx == -1) {
